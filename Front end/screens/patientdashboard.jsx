 ...
 */
export default function PatientDashboard({ onViewProfile, onOpenBooking, onOpenUserProfile, onLogout } = {}) {
  ...
  useEffect(() => {
    ...
    // Auto-refresh caregivers every 2 seconds when on home tab for near-instant updates
  ...
  const fetchCaregivers = async (showLoadingSpinner = true) => {
    try {
      ...
      const response = await axios.get(`${API_URL}/patient/caregivers/approved?limit=10`, {
        headers: {
      ...
      if (response.data.success) {
        const newCaregivers = response.data.caregivers;
        console.log(`[${new Date().toLocaleTimeString()}] Fetched ${newCaregivers.length} available caregivers`);
        ...
        <ScrollView showsVerticalScrollIndicator={false} style={styles.scrollView}>
          ...
          <View style={styles.header}>
              ...
              <View style={styles.userInfoContainer}>
                ...
                {lastUpdate && (
                  <Text style={styles.lastUpdateText}>
                    🔄 Live • Updated {Math.floor((new Date() - lastUpdate) / 1000)}s ago
                  </Text>
                )}
              </View>
            ...
            <View style={styles.searchContainer}>
              ...
              <TextInput
                placeholder="Search caregivers or nurses..."
          ...
          <View style={styles.professionalsSection}>
            ...
            {loading ? (
              ...
              <View style={styles.emptyContainer}>
                <Text style={styles.emptyText}>No caregivers available at the moment</Text>
              </View>
            ) : (
                ...
                {bookings.map((booking) => (
                  <View key={booking._id} style={styles.bookingCard}>
                    ...
                    <View style={styles.bookingFooter}>
                      <Text style={styles.bookingTime}>{booking.serviceTime}</Text>
            ...
            {userProfile ? (
              <View style={styles.profileContent}>
                ...
                <View style={styles.profileActions}>
                  ...
                  <TouchableOpacity style={styles.profileActionButtonDanger} onPress={onLogout}>
