  ...
  const checkBookingStatus = async () => {
    ...
    try {
      ...
      if (response.data.success) {
        ...
        if ((status === 'approved' || status === 'confirmed') && previousStatus !== status) {
          // Booking approved - move to service tracking flow
          Alert.alert(
            'Booking Approved!',
            'The caregiver has accepted your booking request. You can now track the service in real time.',
            [
              {
                text: 'Track Service',
        ...
        } else if (status === 'rejected' && previousStatus !== status) {
          // Booking rejected
          Alert.alert(
            'Booking Declined',
